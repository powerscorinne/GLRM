...
from functions import ordinal_loss_flat, zero_reg, norm1_reg, norm2sq_reg
...
# compare to pca
A_mu = A.mean(0)
A_centered = A - A_mu # subtract out col mean
A_var = diag(A_centered.T.dot(A_centered))/m
A_std = A_centered/A_var # divide by col variance
u, s, v = svd(A_std)
